...
/// <summary>
/// Raw payload returned by GridDataHandler endpoint.
/// Supports both legacy direct Data/Columns payloads and Ivanti metaData/rows payloads.
/// </summary>
public class GridDataHandlerPayload
{
