...
public class FormDefaultDataDto
{
    public class FormDefaultDataContainerDto
    {
        ...
        public FormDataModelDto? FormData { get; set; }
    ...
    public class ReferencedFieldDefinitionDto
    {
    ...
    public class FormDataModelDto
    {
        [JsonPropertyName("__type")]
        public string? Type { get; set; }

        [JsonPropertyName("Objects")]
        public Dictionary<string, DataObjectDto> Objects { get; set; } = new();
